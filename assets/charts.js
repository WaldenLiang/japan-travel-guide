...
(function() {
  ...
  budgetChart.setOption({
    ...
    series: [{
      ...
      data: [
        ...
        { value: 6300, name: '住宿', itemStyle: { color: accent } },
        { value: 1820, name: '门票景点（含和服体验）', itemStyle: { color: warmGold } },
  ...
  var accommodation = [550, 550, 550, 650, 650, 650, 675, 675, 675, 675, 0];
  var tickets = [0, 850, 0, 540, 100, 80, 0, 0, 40, 0, 0];
